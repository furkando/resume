export const resumeData = {
  main: {
    ...
    description:
      "I am a software developer, focused on web technologies. I have experience using some programming languages such as JavaScript and Python, in collaboration with HTML and CSS to build amazing and complex web sites; involving beautiful interfaces, client side logic (front-end), and server side logic (back-end). I have knowledge in Computer Science, Responsive Web Design, Object Oriented Programming, APIs and Microservices, Database Management, among others.",
    ...
    social: [
      {
        name: "facebook",
        url: "http://facebook.com/furkandoganktf",
        className: "fa fa-facebook",
      },
      {
        name: "twitter",
        url: "http://twitter.com/furkandoganktf",
      ...
      {
        name: "instagram",
        url: "http://instagram.com/furkandoganktf",
      ...
      {
        name: "skype",
        url: "https://join.skype.com/invite/aGeKHP5NuDK8",
  ...
  resume: {
    education: [
      ...
      },
      {
        ...
        endYear: 2020,
        description:
          "Co-Founder and Vice President at METU R&D Society, Vice President at IEEE METU",
      },
      {
        school: "Mardin Science High School",
        degree: "High School",
        startYear: 2009,
        endYear: 2014,
        description:
          "Just an ordinary High School at some forgotten place of Turkey.",
      },
    ],
    work: [
      {
